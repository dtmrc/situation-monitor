...
export function useMockDataFeed() {
  ...
  useEffect(() => {
    ...
    // Generate initial mock flight tracks with different categories
    const mockFlights: Track[] = [
      ...
      },
      {
        ...
        status: 'active',
        lastUpdate: new Date().toISOString(),
        flightCategory: 'helicopter',
      },
      {
        id: 'flight-6',
        type: 'flight',
        callsign: 'AAL7700',
        coordinates: [-77.8, 39.0] as [number, number],
        heading: 220,
        speed: 280,
        altitude: 12000,
        origin: 'DCA',
      ...
      },
      {
        ...
        type: 'flight',
        callsign: 'DJI001',
        coordinates: [-76.5, 38.7] as [number, number],
        heading: 60,
        speed: 35,
        altitude: 400,
        status: 'active',
      ...
      },
      {
        ...
        type: 'flight',
        callsign: 'DAL456',
        coordinates: [-77.3, 39.5] as [number, number],
        heading: 135,
        speed: 420,
        altitude: 33000,
        origin: 'ATL',
